...
$qr_pointage_api = "https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=" . urlencode($url_pointage_global);
$qr_anonyme_api = "https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=" . urlencode($url_avis_anonyme);
$qr_select_api = "https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=" . urlencode($url_avis_select);
?>
            ...
            <div class="card card-omega text-white text-center p-4 h-100">
                <div class="card-body">
                    ...
                    <div class="bg-white p-3 d-inline-block rounded shadow mb-3">
                        <img src="<?= $qr_pointage_api ?>" alt="QR Pointage" class="img-fluid">
                    </div>
        ...
        <div class="col-md-4">
            <div class="card card-omega text-white text-center p-4 h-100">
                <div class="card-body">
                    ...
                    <div class="bg-white p-3 d-inline-block rounded shadow mb-3">
                        <img src="<?= $qr_anonyme_api ?>" alt="QR Anonyme" class="img-fluid">
                    </div>
                    <div class="d-grid gap-2">
        ...
        <div class="col-md-4">
            <div class="card card-omega text-white text-center p-4 h-100">
                <div class="card-body">
                    ...
                    <div class="bg-white p-3 d-inline-block rounded shadow mb-3">
                        <img src="<?= $qr_select_api ?>" alt="QR Select" class="img-fluid">
                    </div>
                    <div class="d-grid gap-2">
